...
# This parameter points to the library that contains the â€œvisualâ€?information on the logic cells in the synthesis technology library. All logic cells have a symbolic representation and information about the symbols is stored in this library.
...
##################################################################
set myFiles [glob network/*.sv]; # RTL source files
set fileFormat sverilog; # verilog or sverilog
set basename network_syn; # Top-level module name
...
# Timing information
set clkPeriodNS 6 ; # Desired clock period (in ns)
